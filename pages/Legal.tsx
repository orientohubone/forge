        ...
        <div className="mt-12 space-y-12">
            <section className="bg-white/5 p-8 rounded-3xl border border-white/5 backdrop-blur-sm">
                ...
                <p className="text-gray-400 leading-relaxed font-light">
                    Ao acessar o LearnHub Pro, você concorda em cumprir estes termos de serviço, todas as leis e regulamentos aplicáveis ​​e concorda que é responsável pelo cumprimento de todas as leis locais aplicáveis. Se você não concordar com algum desses termos, está proibido de usar ou acessar este site.
                </p>
            </section>
            ...
            <section className="bg-white/5 p-8 rounded-3xl border border-white/5 backdrop-blur-sm">
                ...
                <p className="text-gray-400 leading-relaxed font-light">
                    As moedas virtuais (LearnCoins) e XP adquiridos na plataforma não possuem valor monetário real fora do ambiente da LearnHub Pro e não podem ser trocados por moeda fiduciária. Elas servem exclusivamente para desbloquear funcionalidades e personalizar a experiência dentro da plataforma.
                </p>
            </section>
            ...
            <section className="bg-white/5 p-8 rounded-3xl border border-white/5 backdrop-blur-sm">
                ...
                <p className="text-gray-400 leading-relaxed font-light">
                    Sua privacidade é importante para nós. É política do LearnHub Pro respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site LearnHub Pro, e outros sites que possuímos e operamos. Solicitamos informações pessoais apenas quando realmente precisamos delas para lhe fornecer um serviço.
                </p>
            </section>
        </div>
      </div>
